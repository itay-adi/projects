...
typedef int (*hash_table_func_t)(const void *data1, void *param);
...
typedef int (*hash_is_match_func_t)(const void *data, void *param);
...
*   - returns the number of elements in hash table buckets.
       return all of the elements in the hash
* 
* Args:
...
*     return the table size (active/inactive)
* Args:
*   - hash - pointer to the hash table
*  
* Return Value:
